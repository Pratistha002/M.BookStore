...
function Signup() {
  ...
  <div className="modal-box">
    ...
    <h3 className="font-bold text-lg text-teal-400">Signup</h3>
...
<div className="flex justify-around mt-4">
    <button className="bg-red-500 text-white rounded-md px-3 py-1 hover:bg-red-800 duration-200">Signup</button>
